...
2. Ein aus Punkt 1 resultierendes Problem ist, dass das Training Set nicht immer ohne Fehlklassifizierungen separiert werden kann. Bei einer harten Marge könnte auf diese Weise keine Modellierung erfolgen. Um eine Separation mit möglichst wenig Fehlern von $\xi_{i}$ zu ermöglichen, wird bei der C-Support Vector Klassifikation[^9] u.a. die Konstante $C$ verwendet. Auf diese Weise wird eine *soft margin Hyperplane* erstellt, wobei mit größerem $C$ die Marge kleiner wird. [vgl. @cortes1995support 280 ff.; @chang2011libsvm: 3]:
\begin{equation*}
\begin{aligned}
