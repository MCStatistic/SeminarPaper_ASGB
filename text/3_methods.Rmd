...
Neben dem Random Forest Ursprünglich wurden Support Vector Machines für die binäre Klassifikation entwickelt [vgl. @cortes1995support 290]. Prinzipiell können Support Vector Machines auch nur binäre Klassifikationsprobleme lösen, jedoch gibt es Ansätze, mit welchen eine Multiklassifikation umgesetzt werden kann. 

Das grundlegende Konzept von Support Vector Machines soll anhand der Arbeit von @cortes1995support in Kürze dargelegt werden. 

\begin{figure}[!h]
	\caption{Visuelle Darstellung einer linearen Support Vector Machine}
	\label{svm_theory}
	\centering
	\includegraphics[width = 0.8\textwidth]{images/svm_grafische_darstellung_theory.png}
	\flushright
	{\scriptsize Darstellung anlehndend an die Darstellung von Cortes \& Vapnik (vgl. Cortes \& Vapnik 1995: 275) \par}
\end{figure}
