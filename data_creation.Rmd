...
base_19 <- rep("http://dipbt.bundestag.de/dip21/btd/19/0", each = 6100) 

# code explaining: replicate the character ".pdf" 5800 times
end_19 <- rep(".pdf", each = 6100)
mid_19 <- rep("/190", each = 6100)
