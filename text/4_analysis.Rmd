...
Die Hypothese *H3* kann in Hinblick der Ergebnisse als tendenziell bestätigt angesehen werden. Zwar liegen einige signifikante Unterschiede bei den Sentiments vor und eine Heterogenität der Sentiments kann ebenso festgestellt werden, jedoch ist dies zwischen den Parteien nicht konsistent der Fall. Anderseits ist die Analyse mittels inferenzstatistischer Methoden in Anbetracht der teilweise sehr geringen Fallzahlen als kritisch einzustufen. *H3* kann folglich nur als tendenziell bestätigt angesehen werden. Um diesen Punkt besser beurteilen zu können, sind detailliertere Analysen mit einer größeren Datengrundlage notwendig.
